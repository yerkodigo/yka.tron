...
" ==========================
" Color Variables - Retro Monochrome Terminal
" ==========================
let s:fg       = {'gui': '#c10b0b', 'cterm256': '160'}  " Rojo intenso
let s:bg       = {'gui': '#000000', 'cterm256': '16'}   " Negro puro
let s:surface  = {'gui': '#1a0d0d', 'cterm256': '233'}  " Superficie sutil (casi negro con tinte rojo)
